...
unrealRootPath=/home/steff/git/UnrealEngine
HelloWordldRootPath=/home/steff/projects_unreal/HelloWordld

gameProjectFile=/home/steff/projects_unreal/HelloWordld/HelloWordld.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(HelloWordldSource.pri)
include(HelloWordldHeader.pri)
include(HelloWordldConfig.pri)
include(HelloWordldIncludes.pri)
include(HelloWordldDefines.pri)
...
HelloWordld-Linux-Debug.commands = $$build HelloWordld Linux Debug  -project="\"$$gameProjectFile\"" $$args
HelloWordld-Linux-DebugGame.commands = $$build HelloWordld Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
HelloWordld-Linux-Shipping.commands = $$build HelloWordld Linux Shipping  -project="\"$$gameProjectFile\"" $$args
HelloWordld-Linux-Test.commands = $$build HelloWordld Linux Test  -project="\"$$gameProjectFile\"" $$args
HelloWordld.commands = $$build HelloWordld Linux Development  -project="\"$$gameProjectFile\"" $$args

HelloWordldEditor-Linux-Debug.commands = $$build HelloWordldEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
HelloWordldEditor-Linux-DebugGame.commands = $$build HelloWordldEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
HelloWordldEditor-Linux-Shipping.commands = $$build HelloWordldEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
HelloWordldEditor-Linux-Test.commands = $$build HelloWordldEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
HelloWordldEditor.commands = $$build HelloWordldEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	HelloWordld-Linux-Debug \
	HelloWordld-Linux-DebugGame \
	HelloWordld-Linux-Shipping \
	HelloWordld-Linux-Test \
	HelloWordld \
	HelloWordldEditor-Linux-Debug \
	HelloWordldEditor-Linux-DebugGame \
	HelloWordldEditor-Linux-Shipping \
	HelloWordldEditor-Linux-Test \
	HelloWordldEditor \
